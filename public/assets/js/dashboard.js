...
(function (global, factory) {
    ...
    class PushMenu {
        ...
        expand() {
            ...
            document.querySelector('.brand-link-lg').style.display = 'flex';
            document.querySelector('.brand-link-sm').style.display = 'none';
        ...
        collapse() {
            ...
            document.querySelector('.brand-link-lg').style.display = 'none';
            document.querySelector('.brand-link-sm').style.display = 'flex';
            this._element.dispatchEvent(event);
        }
